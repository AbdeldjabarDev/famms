...
<ul className="w-60 h-fit mr-20 border border-white">
...
<li><ul className="flex flex-row gap-8 mt-6  w-fit">
    <li><a><img className="border border-orange-500 cursor-pointer" src="/images/facebook-svgrepo-com.svg"  alt="social media" width="65" height="65"></img></a></li>
    <li><a><img className="border border-orange-500 cursor-pointer" src="/images/instagram-svgrepo-com.svg" alt="social media" width="65" height="65"></img></a></li>
    <li><a><img className="border border-orange-500 cursor-pointer" src="/images/twitter-svgrepo-com.svg"   alt="social media" width="65" height="65"></img></a></li>
    <li><a><img className="border border-orange-500 cursor-pointer" src="/images/linkedin-svgrepo-com.svg"  alt="social media" width="65" height="65"></img></a></li>
    <li><a><img className="border border-orange-500 cursor-pointer" src="/images/pinterest-svgrepo-com.svg" alt="social media" width="65" height="65"></img></a></li>
